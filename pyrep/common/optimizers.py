...
class CEMOptimizer(Optimizer):
    ...
    def obtain_solution(self, init_mean, init_var, goal):
        ...
        #####visualisation
        # self.record_i+=1
        # savemat('/home/wawa/RL_transport_3D/mpc_visualisation1/mpc_visualisation{0}.mat'.format(self.record_i), mdict={'arr': store_s})
        # savemat('/home/wawa/RL_transport_3D/mpc_visualisation1/mpc_costs{0}.mat'.format(self.record_i), mdict={'arr': costs})
        ...
        return mean,elites,np.array(store_top_states),np.array(store_bad_states)