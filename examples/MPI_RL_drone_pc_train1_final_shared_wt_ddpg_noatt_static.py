...
from pyrep.envs.bacterium_environment_mpi_pc_global_5m_wt_ddpg_static import Drone_Env
from pyrep.common.arguments_v0 import get_args
from pyrep.policies.maddpg_drone_att_pc1_shared_wt_ddpg_noatt_static import MADDPG
