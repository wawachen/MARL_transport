...
from pyrep.common.replay_buffer import Meta_Buffer
...
def run(args, env, agents,rank,comm):
    ...
    log_path = os.getcwd()+"/log_drone3_MPI_pc1_global_env{}".format(rank)
    ...
    for i in range(max_episodes):
        ...
        logger.add_scalar('mean_episode_pc1_yy1_rewards{}'.format(rank), score, i)
...
if __name__ == '__main__':
    ...
    args.save_dir = "./model_drone3_mpi_pc1_global_train{}".format(rank)
