...
import os
from pyrep.envs.bacterium_environment_mpi_og import Drone_Env
from pyrep.common.arguments import get_args
from mpi4py import MPI
from pyrep.policies.maddpg_drone_att_og import MADDPG
...
def run(args, env, agents,rank,comm):
    ...
    buffer = Buffer(args)
    log_path = os.getcwd()+"/log_drone3_MPI_d1_og_env{}".format(rank)
...
if __name__ == '__main__':
    ...
    args.save_dir = "./model_drone3_mpi_d_og"
    args.scenario_name = "navigation_drone3_mpi_d_og"
    args.env_size = 2
    args.use_gpu = False
