...
import os
from pyrep.envs.bacterium_environment_mpi_pc_local import Drone_Env
from pyrep.common.arguments import get_args
from mpi4py import MPI
from pyrep.policies.maddpg_drone_att_pc1_local import MADDPG
...
def run(args, env, agents,rank,comm):
    ...
    log_path = os.getcwd()+"/log_drone3_MPI_pc1_local_env{}".format(rank)
    ...
    for i in range(max_episodes):
        ...
        logger.add_scalar('mean_episode_pc1_local_rewards{}'.format(rank), score, i)
...
if __name__ == '__main__':
    ...
    args.save_dir = "./model_drone3_mpi_pc1_local_train{}".format(rank)
