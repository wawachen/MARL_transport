...
from pyrep.common.rollout_drone_navigation_stratch_new import Rollout
...
if __name__ == '__main__':
    ...
    args.save_dir = "./model_drone3_stratchnew"
    args.scenario_name = "navigation_drone3_stratchnew"
