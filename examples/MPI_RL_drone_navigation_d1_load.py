...
import os
from pyrep.envs.bacterium_environment_mpi_load import Drone_Env
...
def run(args, env, agents,rank,comm):
    ...
    buffer = Buffer(args)
    log_path = os.getcwd()+"/log_drone3_MPI_d1_env_load{}".format(rank)
...
if __name__ == '__main__':
    ...
    args.save_dir = "./model_drone3_mpi_d_load"
    args.scenario_name = "navigation_drone3_mpi_d_load"
    args.env_size = 2
    args.use_gpu = False
