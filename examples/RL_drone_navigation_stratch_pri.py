...
import os
from pyrep.envs.bacterium_environment_scratch import Drone_Env
# from pyrep.policies.dqn import DQNAgent
from pyrep.common.arguments import get_args
from pyrep.common.rollout_drone_navigation_stratch_pri import Rollout
...
if __name__ == '__main__':
    ...
    args.save_dir = "./model_drone3_pri"
    args.scenario_name = "navigation_drone3_pri"
    args.batch_size = 256
