...
import os
from pyrep.envs.bacterium_environment_state import Drone_Env
# from pyrep.policies.dqn import DQNAgent
from pyrep.common.arguments import get_args
from pyrep.common.rollout_drone_navigation_state import Rollout
...
if __name__ == '__main__':
    ...
    args.save_dir = "./state_model_drone6_att"
    args.scenario_name = "state_navigation_drone6_att"
