...
import os
from pyrep.envs.bacterium_environment_obs import Drone_Env
# from pyrep.policies.dqn import DQNAgent
from pyrep.common.arguments import get_args
from pyrep.common.rollout_drone_navigation_obs import Rollout
...
if __name__ == '__main__':
    ...
    num_agents = 5 #only the first one is agent three for obstacle
    # create multiagent environment
    env = Drone_Env(env_name,num_agents)
 
    args.high_action = 1
    args.max_episodes = 8000 #8000
    args.max_episode_len = 40 #60
    ...
    args.save_dir = "./model_drone1_obs"
    args.scenario_name = "navigation_drone1"
